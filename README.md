...
- **Version in the title** — read from the manifest and shown in brackets after the command name, so there is one place to bump
...
| `core.display_name()` | Puts the manifest version in brackets after the command name. |
